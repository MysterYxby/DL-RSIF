...
import os
import cv2
from model_fusionnet import FusionNet  # 假设这个模块存在并包含PNN类定义
...
class ImageTest:
    def __init__(self, device,dataset_name):
        ...
        self.scale = 2047
        self.device = device
        self.model = FusionNet(spectral_num = self.bands[self.dataset_name]).to(self.device)
        self.path = {
            #qb
            'qb_model_path':'pretrained-model/QB/fusionnet.pth',    #4bands
            ...
            'qb_fusion_dir':'output/FusionNet/qb',
            #gf
            'gf2_model_path':'pretrained-model/QB/fusionnet.pth',    #4bands
            ...
            'gf2_fusion_dir':'output/FusionNet/gf2',
            #wv2
            'wv2_model_path':'pretrained-model/WV2/fusionnet.pth',    #8bands
            ...
            'wv2_fusion_dir':'output/FusionNet/wv2',
            #wv3
            'wv3_model_path':'pretrained-model/WV3/fusionnet.pth',    #8bands
            ...
            'wv3_fusion_dir':'output/FusionNet/wv3'
        }
