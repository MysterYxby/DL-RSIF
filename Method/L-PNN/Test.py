...
class ImageTest:
    def __init__(self, device,dataset_name):
        ...
        self.scale = 2047
        self.device = device
        self.model = LPNN(n_channels = self.bands[self.dataset_name]+1).to(self.device)
        self.path = {
            #qb
            'qb_model_path':'pretrained-model/L-PNN/GE1_L-PNN_model.tar',    #4bands
            ...
            'qb_fusion_dir':'output/L-PNN/qb',
            #gf
            'gf2_model_path':'pretrained-model/L-PNN/GE1_L-PNN_model.tar',    #4bands
            ...
            'gf2_fusion_dir':'output/L-PNN/gf2',
            #wv2
            'wv2_model_path':'pretrained-model/L-PNN/WV2_L-PNN_model.tar',    #8bands
            ...
            'wv2_fusion_dir':'output/L-PNN/wv2',
            #wv3
            'wv3_model_path':'pretrained-model/L-PNN/WV3_L-PNN_model.tar',    #8bands
            ...
            'wv3_fusion_dir':'output/L-PNN/wv3'
        }
