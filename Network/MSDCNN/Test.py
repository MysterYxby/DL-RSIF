...
import os
import cv2
from model_msdcnn import MSDCNN  # 假设这个模块存在并包含PNN类定义
...
class ImageTest:
    def __init__(self, device,dataset_name):
        ...
        self.scale = 2047
        self.device = device
        self.model = MSDCNN(spectral_num = self.bands[self.dataset_name]).to(self.device)
        self.path = {
            #qb
            'qb_model_path':'pretrained-model/QB/msdcnn.pth',    #4bands
            ...
            'qb_fusion_dir':'output/MSDCNN/qb',
            #gf
            'gf2_model_path':'pretrained-model/QB/msdcnn.pth',    #4bands
            ...
            'gf2_fusion_dir':'output/MSDCNN/gf2',
            #wv2
            'wv2_model_path':'pretrained-model/WV2/msdcnn.pth',    #8bands
            ...
            'wv2_fusion_dir':'output/MSDCNN/wv2',
            #wv3
            'wv3_model_path':'pretrained-model/WV3/msdcnn.pth',    #8bands
            ...
            'wv3_fusion_dir':'output/MSDCNN/wv3'
        }
