...
class ImageTest:
    def __init__(self, device,dataset_name):
        ...
        self.scale = 2047
        self.device = device
        self.model = BDPN(spectral_num = self.bands[self.dataset_name]).to(self.device)
        self.path = {
            #qb
            'qb_model_path':'pretrained-model/QB/bdpn.pth',    #4bands
            ...
            'qb_fusion_dir':'output/BDPN/qb',
            #gf
            'gf2_model_path':'pretrained-model/QB/bdpn.pth',    #4bands
            ...
            'gf2_fusion_dir':'output/BDPN/gf2',
            #wv2
            'wv2_model_path':'pretrained-model/WV2/bdpn.pth',    #8bands
            ...
            'wv2_fusion_dir':'output/BDPN/wv2',
            #wv3
            'wv3_model_path':'pretrained-model/WV3/bdpn.pth',    #8bands
            ...
            'wv3_fusion_dir':'output/BDPN/wv3'
        }
    ...
    def process_image_and_save_tif(self, ms_data, pan_data, output_path,idx):
        ...
        with torch.no_grad():
            output_tensor,_ = self.model(ms_tensor.unsqueeze(0),pan_tensor.unsqueeze(0))
